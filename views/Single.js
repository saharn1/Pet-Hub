  ...
  return (
    <ScrollView>
      <Card>
        ...
        <Card.Divider />
        <Text style={styles.pet_name}>{file.pet_name}</Text>
        <Card.Divider />
        <Text style={styles.pet_type}>{file.pet_type}</Text>
        <Card.Divider />
        <Text style={styles.pet_age}>{file.pet_age}</Text>
        <Card.Divider />
        <Text style={styles.pet_health}>{file.pet_health}</Text>
        <Card.Divider />
        <Text style={styles.pet_description}>{file.pet_description}</Text>
        <Card.Divider />
        <ListItem>
